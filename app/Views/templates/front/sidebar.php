<nav class="navbar fixed-top navbar-expand-lg bg-body-tertiary">
    <div class="container">
        <a class="navbar-brand" href="#"><img src="<?= base_url('/assets/brand/blabla.png') ?>" class="sidebar-brand-narrow" _width="32" height="32" alt="Blabla-voiture" /> Blabla-voiture</a>
            ...
            <div class="navbar-nav d-flex">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li><a class="dropdown-item" href="<?= base_url('/login/logout'); ?>"><i class="fa-solid
